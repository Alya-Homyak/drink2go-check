...
var paginationButtons = document.querySelectorAll(".hero__pagination-button");
var isLast = false;
var isFirst = true;
var current = 0;
function nextSlide() {
...
var prevButton = document.querySelector(".hero__slider-button--prev");
prevButton.addEventListener("click", prevSlide);
var nextButton = document.querySelector(".hero__slider-button--next");
...
var paginationContainer = document.querySelector(".hero__pagination");
paginationContainer.addEventListener("click", onPaginationClick);

// source/vendor/nouislider/nouislider.js
(function(global, factory) {
  ...
  function scope(target, options, originalOptions) {
    ...
    function generateSpread(pips2) {
      ...
      group.forEach(function(current2, index) {
        var step;
        var i;
        var q;
        var low = current2;
...
var navButton = document.querySelector(".header__navigation-button");
var navSection = document.querySelector(".navigation");
function onClicked() {
